...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                    style="background-image: url(client/images/bg_2.jpg);">
                    ...
                    <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                        <div class="room">
                            ...
                            <div class="text p-3 text-center">
                                ...
                                <p><span class="price mr-2">{{ number_format($type->price) }}đ</span> <span
                                ...
                                <hr>
                                <p class="pt-1">
                                    <a href="{{ route('rooms-single', ['typeId' => $type->id]) }}" class="btn-custom">
    ...
    <section class="ftco-section ftco-counter img" id="section-counter"
        style="background-image: url(client/images/bg_1.jpg);">
        <div class="container">
                        ...
                        <div class="col-md-12">
                            <div class="carousel-testimony owl-carousel ftco-owl">
                                <div class="item">
                                    <div class="testimony-wrap py-4 pb-5">
                                        <div class="user-img mb-4"
                                            style="background-image: url(client/images/person_1.jpg)">
                                ...
                                <div class="item">
                                    <div class="testimony-wrap py-4 pb-5">
                                        <div class="user-img mb-4"
                                            style="background-image: url(client/images/person_2.jpg)">
                                            <span class="quote d-flex align-items-center justify-content-center">
                                                <i class="icon-quote-left"></i>
                                            </span>
                                        </div>
                                ...
                                <div class="item">
                                    <div class="testimony-wrap py-4 pb-5">
                                        <div class="user-img mb-4"
                                            style="background-image: url(client/images/person_3.jpg)">
                                            <span class="quote d-flex align-items-center justify-content-center">
                                                <i class="icon-quote-left"></i>
                                            </span>
                                        </div>
        ...
        <div class="container">
            ...
            <div class="row d-flex">
                <div class="col-md-3 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('client/images/image_1.jpg');">
                        </a>
                ...
                <div class="col-md-3 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('client/images/image_2.jpg');">
                        </a>
                        <div class="text mt-3">
                            <h3 class="heading mt-3"><a href="#">Even the all-powerful Pointing has no control about
                                    the blind texts</a></h3>
                ...
                <div class="col-md-3 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('client/images/image_3.jpg');">
                        </a>
                        <div class="text mt-3">
                            <h3 class="heading mt-3"><a href="#">Even the all-powerful Pointing has no control about
                                    the blind texts</a></h3>
                ...
                <div class="col-md-3 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('client/images/image_4.jpg');">
                        </a>
                        <div class="text mt-3">
                            <h3 class="heading mt-3"><a href="#">Even the all-powerful Pointing has no control about
                                    the blind texts</a></h3>
        ...
        <div class="container-fluid">
            ...
            <div class="row no-gutters">
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="client/images/insta-1.jpg" class="insta-img image-popup"
                        style="background-image: url(client/images/insta-1.jpg);">
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="client/images/insta-2.jpg" class="insta-img image-popup"
                        style="background-image: url(client/images/insta-2.jpg);">
                        <div class="icon d-flex justify-content-center">
                            <span class="icon-instagram align-self-center"></span>
                        </div>
                    </a>
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="client/images/insta-3.jpg" class="insta-img image-popup"
                        style="background-image: url(client/images/insta-3.jpg);">
                        <div class="icon d-flex justify-content-center">
                            <span class="icon-instagram align-self-center"></span>
                        </div>
                    </a>
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="client/images/insta-4.jpg" class="insta-img image-popup"
                        style="background-image: url(client/images/insta-4.jpg);">
                        <div class="icon d-flex justify-content-center">
                            <span class="icon-instagram align-self-center"></span>
                        </div>
                    </a>
                ...
                <div class="col-sm-12 col-md ftco-animate">
                    <a href="client/images/insta-5.jpg" class="insta-img image-popup"
                        style="background-image: url(client/images/insta-5.jpg);">
                        <div class="icon d-flex justify-content-center">
                            <span class="icon-instagram align-self-center"></span>
                        </div>
                    </a>
